...
const resumeJson = {
  ...
  certifications: [
    { name: 'Microsoft Back-End Developer Professional Certificate', issuer: 'Microsoft' },
    ...
    { name: 'Security and Authentication', issuer: 'Microsoft' },
    { name: 'Performance Optimization and Scalability', issuer: 'Microsoft' },
    { name: 'Data Structures and Algorithms', issuer: 'Microsoft' },
    { name: 'Deployment and DevOps', issuer: 'Microsoft' },
